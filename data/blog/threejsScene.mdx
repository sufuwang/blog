...
&nbsp;
# 1. 光源
| 光源类型 | 构造函数 | <div style={{ whiteSpace: 'nowrap' }}>方向</div> | <div style={{ whiteSpace: 'nowrap' }}>范围衰减</div> | <div style={{ whiteSpace: 'nowrap' }}>投影阴影</div> | 常用用途 |
| ------- | ------ | ---- | ------ | ------- | ------ |
...
| `WebGPURenderer` | 下一代 WebGPU 技术（实验） | 高端设备/性能极限应用 |
&nbsp;

# 4. 控制器
| 控制器名称 | 功能描述 | 鼠标操作 | <div style={{ whiteSpace: 'nowrap' }}>动画轨迹</div> | 常见用途 |
| ----------------------------- | ----------------------------- | ------------------------------ | -------- | --------------------- |
