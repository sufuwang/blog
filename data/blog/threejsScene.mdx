...
```
<ThreeJsSceneControls />
&nbsp;

# 5. 资源加载
| <div style={{ whiteSpace: 'nowrap', minWidth: '120px' }}>加载器</div> | <div style={{ whiteSpace: 'nowrap', minWidth: '100px' }}>加载类型</div> | 类名 | <div style={{ whiteSpace: 'nowrap', minWidth: '180px' }}>文件格式</div> | <div style={{ whiteSpace: 'nowrap' }}>是否异步</div> |
| ---------- | -------- | ------------------------- | ------------------------- | --------------------------- |
...
# 7. 创建 Mesh
<a href='/blog/threejsMesh'>THREE.js 知识: 创建 Mesh</a>
<br />
&nbsp;
